...
$targetFiles = @(
    "banten_nasi_sumsum.jpeg",
    "banten_pecak_bandeng.jpeg",
    "banten_sayur_besan.jpeg",
    "banten_sate_bebek.jpeg",
    "banten_laksa_tangerang.jpeg",
    "banten_kue_jojorong.jpeg",
    "banten_kue_pasung.jpeg"
)
...
Write-Host "Banten Compression Complete!"
