...
$targetFiles = @(
    "jawa_barat_nasi_timbel.jpeg",
    "jawa_barat_soto_mie_bogor.jpeg",
    "jawa_barat_batagor.jpeg",
    "jawa_barat_mie_kocok.jpeg",
    "jawa_barat_pepes_ikan.jpeg",
    "jawa_barat_nasi_tutug_oncom.jpeg",
    "jawa_barat_es_goyobod.jpeg"
)
...
Write-Host "Jawa Barat Compression Complete!"
