...
$targetFiles = @(
    "jawa_tengah_tahu_gimbal.jpeg",
    "jawa_tengah_nasi_gandul.jpeg",
    "jawa_tengah_selat_solo.jpeg",
    "jawa_tengah_mangut_beong.jpeg",
    "jawa_tengah_sate_buntel.jpeg",
    "jawa_tengah_mie_ongklok.jpeg",
    "jawa_tengah_dawet_ireng.jpeg"
)
...
Write-Host "Jawa Tengah Compression Complete!"
