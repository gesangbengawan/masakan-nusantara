...
$targetFiles = @(
    "di_yogyakarta_oseng_mercon.jpeg",
    "di_yogyakarta_bakmi_jawa.jpeg",
    "di_yogyakarta_sate_kere.jpeg",
    "di_yogyakarta_jadah_tempe.jpeg",
    "di_yogyakarta_brongkos.jpeg",
    "di_yogyakarta_ayam_kalasan.jpeg",
    "di_yogyakarta_kopi_joss.jpeg"
)
...
Write-Host "DI Yogyakarta Compression Complete!"
