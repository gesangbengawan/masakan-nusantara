...
# Get ONLY aceh images
$images = Get-ChildItem -Path $sourceDir -Filter "aceh_*.jpeg" -Recurse

if ($images.Count -eq 0) {
    Write-Warning "No 'aceh_*.jpeg' images found!"
    exit
}
...
Write-Host "Aceh Compression Complete!"
