...
# Get ONLY Sumbar images
$images = Get-ChildItem -Path $sourceDir -Filter "sumbar_*.jpeg" -Recurse

if ($images.Count -eq 0) {
    Write-Warning "No 'sumbar_*.jpeg' images found!"
    exit
}
...
Write-Host "Sumbar Compression Complete!"
