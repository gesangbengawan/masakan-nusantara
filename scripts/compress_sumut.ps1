...
# Get ONLY Sumut images
$images = Get-ChildItem -Path $sourceDir -Filter "sumut_*.jpeg" -Recurse

if ($images.Count -eq 0) {
    Write-Warning "No 'sumut_*.jpeg' images found!"
    exit
}
...
Write-Host "Sumut Compression Complete!"
