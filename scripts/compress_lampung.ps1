...
$targetFiles = @(
    "lampung_geguduh.jpeg",
    "lampung_gabing.jpeg",
    "lampung_engkak_ketan.jpeg",
    "lampung_gulai_balak.jpeg",
    "lampung_keripik_pisang.jpeg",
    "lampung_sambal_tempoyak.jpeg",
    "lampung_bekasam.jpeg"
)
...
Write-Host "Lampung Compression Complete!"
