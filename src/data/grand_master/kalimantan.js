module.exports = [
    // --- KALIMANTAN BARAT (3 Recipes) ---
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "200 gr Beras (Sangrai dengan kelapa parut, tumbuk kasar)",
            "100 gr Kelapa Parut (Sangrai bersama beras)",
            "1 Liter Kaldu Sapi/Ayam",
            "## Sayuran (Potong Kecil)",
            "Pakis (Pucuk paku), Kangkung, Daun Kesum (Wajib)",
            "Ubi Jalar (Potong dadu), Jagung Manis",
            "## Bumbu Halus",
            "8 Bawang Merah, 4 Bawang Putih",
            "1 sdm Lada Hitam (Dominan)",
            "2 batang Serai, Lengkuas",
            "Terasi Bakar"
        ],
        instructions: [
    ...
    },
    {
        ...
        ingredients: [
            ...
            "1 buah Terong Asam (Kupas, iris)",
            "1 Liter Air",
            "## Bumbu Halus",
            "15 Cabai Kering (Rendam) - Warna merah gelap",
            "8 Bawang Merah, 4 Bawang Putih",
    ...
    },
    {
        ...
        ingredients: [
            ...
            "3 sdm Minyak Goreng",
            "## Isian",
            "1 kg Bengkuang (Serut kasar/potong korek)",
            "100 gr Ebi Kering (Rendam, cincang halus)",
        ...
        instructions: [
            ...
            "**Buat Kulit**: Campur tepung beras, sagu, air, minyak, garam. Masak di wajan anti lengket dengan api kecil sambil diaduk terus sampai menggumpal jadi adonan kalis (seperti bubur sumsum padat). Angkat.",
            "**Uleni**: Saat hangat, uleni adonan kulit dengan sagu kering sampai bisa dipulung.",
            "**Bentuk**: Ambil sedikit adonan, pipihkan TIPIS. Beri isian bengkuang. Tutup bentuk pastel/bulan sabit.",
            "**Kukus**: Alasi kukusan dengan daun pisang oles minyak. Kukus Choipan 10-15 menit (kulit akan transparan).",
    ...
    // --- KALIMANTAN SELATAN (3 Recipes) ---
    {
        ...
        ingredients: [
            "1 ekor Ayam Kampung",
            "2 Liter Air",
            "1 kaleng Susu Evaporasi / Telur Bebek Rebus (hancurkan kuningnya untuk pengental)",
            "## Bumbu Bungkus (Kain Kasa)",
            "5 cm Kayu Manis, 5 Cengkeh, 5 Kapulaga, 2 Bunga Lawang",
            "1/2 butir Pala, 1 sdt Adas Manis (Wajib)",
            "## Bumbu Halus",
            "15 Bawang Merah, 7 Bawang Putih",
            "1 sdt Lada, Jahe, Kunyit (sedikit)",
            "## Pelengkap",
    ...
    },
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "2 ekor Ikan Gabus (Haruan) - Bersihkan, lumuri garam",
            "1 Liter Santan Kental",
            "Ketupat (Tekstur agak keras agar tidak hancur)",
            "## Bumbu Halus",
            "10 Bawang Merah, 5 Bawang Putih",
            "5 butir Kemiri (Sangrai)",
            "3 cm Kunyit (Bakar), 2 cm Kencur, Lengkuas",
            "1 sdt Ketumbar, 1/2 sdt Jinten",
            "Terasi Bakar",
            "Kulit Jeruk Purut (Sedikit)"
        ],
        instructions: [
    ...
    },
    {
        ...
        difficulty: "Mudah",
        ingredients: [
            "1 ekor Ikan Patin Besar (Potong steak/fillet)",
            "Air Jeruk Nipis",
            "## Bumbu Oles Merah",
            "10 Cabai Merah Keriting (Rebus)",
            "5 Bawang Merah, 3 Bawang Putih",
            "1 potong Gula Merah",
            "3 sdm Kecap Manis",
            "1 sdm Air Asam Jawa",
            "Minyak Jelantah (Bekas goreng bawang)"
        ],
        instructions: [
            "**Bersihkan**: Cuci patin, buang lemak perut berlebih (tapi sisakan sedikit karena enak dibakar), kucuri jeruk nipis.",
    ...
    // --- KALIMANTAN TENGAH (3 Recipes) ---
    {
        ...
        cookTime: "40 Menit",
        servings: 4,
        difficulty: "Sedang (Bahan)",
        ingredients: [
            "500 gr Ikan Baung/Patin",
            "200 gr Umbut Rotan (Kupas kulit duri, ambil bagian putih dalam, potong)",
            "1 Liter Santan Encer",
            "1 Terong Asam (Rimbang)",
            "## Bumbu Halus",
            "6 Bawang Merah, 3 Bawang Putih",
            "4 cm Kunyit (Warna kuning terang)",
            "2 cm Jahe, 2 cm Lengkuas",
            "Kemiri",
            "Sejumput Gula (Penyeimbang pahit)"
        ],
        instructions: [
            "**Persiapan Umbut**: Rebus umbut rotan sebentar untuk mengurangi rasa pahit, tiriskan. (Bisa juga langsung dimasak jika suka pahit aslinya).",
            "**Masak Kuah**: Didihkan santan encer dengan bumbu halus, serai, dan lengkuas.",
    ...
    },
    {
        ...
        ingredients: [
            ...
            "## Bahan Fermentasi (Samu)",
            "100 gr Garam Kasar (Banyak)",
            "200 gr Beras Sangrai (Tumbuk kasar menjadi bubuk)",
            "Gula Merah sisir",
            "## Bumbu Goreng",
    ...
    },
    {
        ...
        difficulty: "Mudah",
        ingredients: [
            "2 ikat Kalakai / Pakis Merah (Ambil pucuk muda)",
            "50 gr Ikan Teri / Udang Rebon",
            "## Bumbu Iris",
            "5 Bawang Merah, 3 Bawang Putih",
            "5 Cabai Merah",
        ...
        instructions: [
            "**Petik**: Petik bagian pucuk daun dan batang muda kalakai. Cuci bersih.",
            "**Tumis**: Tumis bumbu iris dan terasi sampai wangi. Masukkan teri/udang.",
            "**Masak Sayur**: Masukkan kalakai. Aduk cepat pakai api besar. Beri sedikit air panas.",
            "**Seasoning**: Garam gula. Masak sebentar saja (layu). Jika terlalu lama, kalakai jadi berlendir.",
            "**Rasa**: Renyah, gurih terasi. Kuahnya akan berwarna sedikit merah/ungu alami."
        ],
        tips: [
    ...
    // --- KALIMANTAN TIMUR (3 Recipes) ---
    {
        ...
        ingredients: [
            ...
            "## Bumbu Halus Merah",
            "15 Cabai Merah Kering (Rebus) - Warna Merah Tua",
            "10 Bawang Merah, 5 Bawang Putih",
        ...
        instructions: [
            "**Tumis Bumbu**: Tumis bumbu halus sampai matang dan keluar minyak merahnya.",
            "**Ungkep**: Masukkan ayam. Aduk rata. Tuang santan. Masak (ungkep) sampai santan menyusut tinggal sedikit (nyemek berminyak) dan ayam empuk.",
            "**Bakar**: Angkat ayam. Bakar di atas arang sebentar saja untuk aroma asap. (Bumbu cincane sudah matang saat diungkep).",
            "**Sajikan**: Siram sisa bumbu ungkep merah kental ke atas ayam bakar. Dagingnya lembut dan bumbu meresap sampai tulang."
        ],
        tips: [
    ...
    },
    {
        ...
        ingredients: [
            "500 gr Beras",
            "700 ml Santan Cair",
            "100 gr Ikan Asin Gabus/Tenggiri (Goreng, suwir)",
            "2 ikat Kemangi (Petik daun)",
            "Minyak Goreng (Minyak Sayur khas Kutai)",
            "## Bumbu Cemplung",
            "2 Serai, 4 Daun Salam, 4 Daun Jeruk",
            "Pandan",
            "Garam"
        ],
        instructions: [
            "**Masak Nasi**: Masukkan beras, santan, minyak sayur, dan rempah daun ke dalam panci kastrol/rice cooker. Masak sampai air menyusut (aron).",
            "**Campur Lauk**: Saat nasi sudah aron (setengah matang), masukkan suwiran Ikan Asin Goreng dan Daun Kemangi. Aduk rata.",
            "**Tanakkkan**: Tutup panci. Masak api SANGAT KECIL sampai matang. Biarkan bagian bawah agak gosong berkerak (intip) karena itu yang dicari.",
            "**Sambal Raja**: Sajikan Nasi Bekepor dengan Sambal Raja (Kutai) yang berisi irisan terong, kacang panjang, dan bawang merah goreng.",
            "**Daging**: Lauk pendampingnya biasanya Daging Masak Bumi Hangus (Kecap)."
        ],
        tips: [
    ...
    },
    {
        ...
        difficulty: "Mudah",
        ingredients: [
            "1 ekor Ikan Gabus (Haruan) Besar - Belah punggung tidak putus",
            "Air Asam Jawa & Garam",
            "## Sambal Gence (Tumis)",
            "15 Cabai Merah Keriting (Ulek kasar)",
            "10 Bawang Merah (Iris kasar/utuh kecil)",
            "1 buah Tomat Merah",
            "Air Asam Jawa (Lagi)",
            "Gula Merah, Garam"
        ],
        instructions: [
            "**Bakar Ikan**: Lumuri ikan gabus dengan garam asam. Bakar di arang sampai matang kering. Sisihkan.",
            "**Buat Sambal Gence**: Tumis bawang merah iris sebentar. Masukkan cabai ulek kasar. Masak sampai layu.",
            "**Seasoning**: Beri air asam jawa (cukup banyak), gula merah, garam. Sambal Gence rasanya harus Asam Manis Pedas dan bawangnya masih bertekstur.",
            "**Siram**: Taruh ikan bakar di piring. Siram sambal gence panas di atasnya sampai menutupi ikan.",
    ...
    // --- KALIMANTAN UTARA (3 Recipes) ---
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "4 ekor Kepiting Soka (Bersihkan, potong 2)",
            "Tepung Bumbu Serbaguna (untuk baluran)",
            "Minyak Goreng",
            "## Saus Tarakan",
            "3 sdm Saus Tiram",
        ...
        instructions: [
            "**Goreng Kepiting**: Balur kepiting soka basah ke tepung kering. Goreng deep fry sampai 'Golden Crispy'. Angkat tiriskan.",
            "**Buat Saus**: Tumis bawang bombay dan putih sampai wangi layu. Masukkan semua saus (tiram, kecap, tomat). Beri sedikit air.",
            "**Lada Hitam**: Masukkan lada hitam kasar. Masak sampai saus mengental meletup.",
            "**Campur**: Matikan api. Masukkan kepiting goreng. Aduk cepat asal rata (jangan sampai lembek).",
    ...
    },
    {
        ...
        difficulty: "Mudah",
        ingredients: [
            "2 buah Timun (Kupas, buang biji, cincang halus)",
            "100 gr Rumput Laut Segar / Kerang Kapah (Rebus sebentar)",
            "1/2 butir Kelapa Parut (Sangrai kering)",
            "## Bumbu Perasa",
            "10 Cabai Rawit (Iris halus)",
            "5 Bawang Merah (Iris halus)",
            "3 Jeruk Nipis/Limau (Peras airnya)",
            "Garam, Gula Pasir, Udang Rebus cincang (Opsional)"
        ],
        instructions: [
            "**Peras Timun**: Campur timun cincang dengan sedikit garam. Peras airnya sampai kering (agar Lawa tidak berair).",
            "**Campur Bahan**: Di mangkuk, campur timun, rumput laut/kerang, udang, kelapa sangrai, cabai iris, bawang iris.",
            "**Matangkan dengan Asam**: Siram dengan air jeruk nipis. Aduk rata. Asam jeruk akan 'mematangkan' bawang dan cabai mentah (seperti Ceviche).",
            "**Seasoning**: Tambahkan gula garam. Hati-hati asin jika pakai kerang/rumput laut asin.",
            "**Sajikan**: Segar, asam, gurih kelapa. Pembuka selera sebelum main course."
        ],
        tips: [
    ...
    },
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "500 gr Daging Kerang Dara/Tudai (Kupas, rebus sebentar)",
            "Tusuk Sate",
            "## Bumbu Oles Merah",
            "10 Cabai Merah, 5 Cabai Rawit",
            "5 Bawang Merah, 3 Bawang Putih",
            "1 sdt Ketumbar",
            "Kecap Manis, Madu, Saus Sambal"
        ],
        instructions: [
            "**Tumis Bumbu**: Haluskan cabai bawang ketumbar. Tumis sampai matang. Beri kecap manis dan madu.",
            "**Marinasi Kerang**: Campur kerang rebus dengan bumbu tumis. Diamkan 15 menit.",
            "**Tusuk**: Tusuk kerang rapat-rapat di tusuk sate.",
            "**Bakar**: Bakar sebentar saja di atas api (kerang sudah matang, hanya butuh aroma asap). Olesi sisa bumbu.",
