module.exports = [
    // --- JAMBI (3 Recipes) ---
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "1 kg Ikan Patin (Potong tebal)",
            "150 gr Tempoyak (Durian fermentasi) - Pilih yang asam wangi",
            "1 Liter Air",
            "2 batang Serai (Geprek)",
            "3 lembar Daun Jeruk",
            "1 lembar Daun Kunyit",
            "## Bumbu Halus (Kuning Pedas)",
            "15 Cabai Merah Keriting + 5 Rawit Merah (Wajib Pedas)",
            "5 cm Kunyit (Bakar)",
            "2 cm Jahe",
            "5 Bawang Merah & 3 Bawang Putih",
            "Gula Pasir (Penyeimbang rasa asam)"
        ],
        instructions: [
    ...
    },
    {
        ...
        ingredients: [
            ...
            "2 lembar Daun Pandan, 2 Daun Salam, 1 Serai",
            "Garam secukupnya",
            "## Pelengkap Wajib",
            "Daging Sapi Suwir Manis (Semur kering)",
            "Telur Dadar Rawis (Iris tipis)",
            "Teri & Kacang Tanah Goreng",
            "Kerupuk Merah",
            "## Sambal Nasi Gemuk",
    ...
    },
    {
        ...
        ingredients: [
            "## Bahan Tepek (Ikan)",
            "500 gr Ikan Gabus/Tenggiri Giling",
            "300 gr Tepung Sagu Tani",
            "200 ml Air Es",
            "3 Bawang Putih Halus + Garam",
            "## Bahan Kuah Gulai Nanas",
            "1/2 buah Nanas (Potong kecil/parut kasar)",
            "700 ml Santan Sedang",
            "## Bumbu Halus Kuah",
            "10 Cabai Merah, 8 Bawang Merah, 3 Bawang Putih",
            "3 cm Kunyit, 2 cm Jahe, 1 sdt Adas Manis (Khas)",
            "1 sdt Ketumbar"
        ],
        instructions: [
    ...
    // --- BENGKULU (3 Recipes) ---
    {
        ...
        servings: 4,
        difficulty: "Sulit (Teknik Bungkus)",
        ingredients: [
            "500 gr Ikan (Kakap/Gebur/Kembung)",
            "3 ikat Daun Talas Muda (untuk isian)",
            "Daun Pisang (untuk pembungkus luar)",
            "1/2 butir Kelapa Parut Setengah Tua (Sangrai sebentar)",
            "3 keping Asam Kandis",
            "## Bumbu Halus (Sangat Kaya Rempah)",
            "10 Bawang Merah, 5 Bawang Putih",
            "15 Cabai Merah, 2 cm Jahe, 4 cm Lengkuas, 3 cm Kunyit",
            "1 sdt Ketumbar, 1/2 sdt Merica"
        ],
        instructions: [
            "**Siapkan Daun Talas**: Cuci bersih daun talas, buang tulang daunnya, remas-remas sedikit agar lemas (dan tidak gatal).",
    ...
    },
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "500 gr Daging Ikan Hiu Punai / Ikan Pari (Potong kotak)",
            ...
            "1/4 butir Pala, 2 butir Cengkeh, 2 cm Kayu Manis",
            "3 cm Jahe & Lengkuas",
    ...
    },
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "500 gr Iga Sapi (Potong)",
            "2 ikat Daun Pakis (Ambil pucuk muda)",
            "1 Liter Santan",
            "## Bumbu Halus",
            "8 Bawang Merah, 4 Bawang Putih, 10 Cabai Merah",
    ...
    // --- SUMATERA SELATAN (3 Recipes) ---
    {
        ...
        cookTime: "30 Menit",
        servings: 5,
        difficulty: "Sulit (Teknik Isi)",
        ingredients: [
            "## Adonan Pempek",
            "500 gr Ikan Tenggiri Giling (Dingin)",
            "350 gr Tepung Sagu Tani",
            "250 ml Air Es",
            "1 sdm Garam + 1 sdt Gula",
            "5 butir Telur Bebek/Ayam (untuk isian)",
            "## Kuah Cuko (Wajib Medok)",
            "500 gr Gula Batok Lubuklinggau (Hitam pekat)",
            "50 gr Cabai Rawit Hijau (Tumbuk kasar)",
            "5 siung Bawang Putih (Tumbuk halus)",
            "2 sdm Cuka Makan + Air Asam Jawa"
        ],
        instructions: [
            "**Buat Adonan**: Campur ikan giling dan air es, aduk sampai menyatu. Masukkan garam & gula, aduk cepat sampai adonan MENGENTAL JELLY. Baru masukkan sagu sedikit demi sedikit. Aduk ringan asal rata (jangan uleni kuat).",
            "**Bentuk Kapal Selam**: Ambil sekepal adonan (balur tangan dengan sagu).  Buat lubang dalam seperti mangkok. Masukkan 1 butir telur (buang sedikit putihnya jika terlalu penuh). Tutup rapat rekat pinggirnya.",
            "**Rebus**: Langsung masukkan ke air mendidih. Rebus sampai mengapung + 10 menit (agar telur matang). Angkat.",
            "**Buat Cuko**: Rebus gula batok dan air sampai larut. Masukkan cabai raswit dan bawang putih tumbuk. Masak sampai mendidih dan agak kental. Beri cuka/asam jawa. Saring (opsional). Cuko harus kental hitam.",
    ...
    },
    {
        ...
        ingredients: [
            ...
            "200 gr Sagu Tani",
            "1 Putih Telur, Garam, Air Es",
            "## Kuah Kaldu Udang",
            "250 gr Udang (Kupas, kulit/kepala untuk kaldu)",
            "1,5 Liter Air",
            "## Isian Sup",
            "Jamur Kuping (Rendam, potong)",
            "Bunga Sedap Malam (Ikat simpul)",
            "Bengkuang (Iris korek api)",
            "Soun (Seduh)",
            "## Bumbu Halus",
            "6 Bawang Putih, 1/2 sdt Lada Bubuk"
        ],
        instructions: [
    ...
    },
    {
        ...
        difficulty: "Mudah",
        ingredients: [
            "1 kg Ikan Patin (Potong steak)",
            "1 buah Nanas (Potong kipas)",
            "1 ikat Kemangi",
            "## Bumbu Geprek (Iris/Memar)",
            "8 Bawang Merah (Bakar sebentar)",
            "4 Bawang Putih (Bakar)",
            "3 cm Kunyit & Jahe (Bakar, geprek)",
            "3 batang Serai, 3 Daun Salam",
            "5 Cabai Merah (Belah dua memanjang)",
            "## Perasa",
            "Air Asam Jawa, Gula Merah, Garam, Kecap Manis (sedikit/opsional)"
        ],
        instructions: [
    ...
    // --- BANGKA BELITUNG (3 Recipes) ---
    {
        ...
        difficulty: "Mudah",
        ingredients: [
            "500 gr Ikan Tenggiri / Kepala Kakap",
            "1/2 buah Nanas (Iris tebal)",
            "1 Liter Air",
            "## Bumbu Halus (Kuning Pedas)",
            "10 Cabai Merah Keriting + 5 Rawit (Wajib Pedas)",
            "8 Bawang Merah (Tanpa Bawang Putih)",
            "4 cm Kunyit (Agar kuning cerah)",
            "2 cm Lengkuas",
    ...
    },
    {
        ...
        ingredients: [
            ...
            "Kaldu Udang (dari kulit/kepala)",
            "Gula Merah (Wajib)",
            "1 sdm Tepung Maizena/Sagu (Pengental)",
            "## Bumbu Halus",
            "8 Bawang Merah, 4 Bawang Putih",
            "1 sdt Lada, 3 butir Kemiri",
            "## Pelengkap",
            "Tahu Goreng, Kentang Rebus (Potong dadu)",
            "Timun, Emping, Tauge"
        ],
        instructions: [
    ...
    },
    {
        ...
        ingredients: [
            ...
            "5 Bawang Merah, 3 Bawang Putih",
            "1 sdt Lada, Garam, Gula",
            "Daun Bawang iris halus",
            "Daun Pisang untuk membungkus",
            "## Sambal Cuko Merah",
            "10 Cabai Merah, 3 Bawang Putih, 1 sdm Tauco/Terasi",
