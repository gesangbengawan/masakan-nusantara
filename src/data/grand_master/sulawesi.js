module.exports = [
    // --- SULAWESI UTARA (3 Recipes) ---
    {
        ...
        image: "sulawesi_utara_bubur_manado.jpeg",
        prepTime: "20 Menit",
        cookTime: "40 Menit",
        servings: 4,
        difficulty: "Mudah",
        ingredients: [
            "200 gr Beras",
            "1 Liter Air + 2 batang Serai",
            "300 gr Labu Kuning (Kukus, lumatkan sebagian agar bubur kuning kental)",
            "1 buah Jagung Manis (Pipil)",
            "1 ikat Kangkung & Bayam",
            "1 ikat Daun Kemangi (Wajib)",
            "Daun Gedi (Jika ada - pengental alami)",
            "## Pelengkap",
            "Ikan Asin Jambal (Goreng kering)",
            "Sambal Roa / Dabu-dabu"
        ],
        instructions: [
    ...
    },
    {
        ...
        image: "sulawesi_utara_ayam_woku.jpeg",
        prepTime: "20 Menit",
        cookTime: "30 Menit",
        servings: 4,
        difficulty: "Sedang",
        ingredients: [
            ...
            "3 ikat Kemangi (Ambil daun)",
            "2 lembar Daun Pandan (Iris kasar)",
            "1 lembar Daun Kunyit (Ikat)",
            "5 lembar Daun Jeruk",
            "2 batang Serai & Daun Bawang",
            "1 buah Tomat merah",
            "## Bumbu Halus (Kuning Pedas)",
            "10 Bawang Merah, 5 Bawang Putih",
            "20 Cabai Rawit (Wajib Pedas)",
            "4 cm Kunyit (Bakar), 3 cm Jahe",
            "4 butir Kemiri"
        ],
        instructions: [
            "**Tumis Aromatik**: Tumis bumbu halus dengan minyak secukupnya. Masukkan daun pandan, daun kunyit, serai, daun jeruk. Masak sampai bumbu matang tanak.",
            "**Masak Ayam**: Masukkan ayam. Aduk rata sampai ayam berubah warna pucat. Beri sedikit air (jangan banyak, Woku Belanga itu nyemek kental).",
            "**Simmer**: Masak api sedang sampai ayam empuk dan bumbu meresap. Bumbui garam gula.",
            "**Finishing**: Masukkan potongan tomat dan daun bawang. Terakhir masukkan DAUN KEMANGI yang banyak. Aduk sebentar sampai layu. Matikan api.",
            "**Sajikan**: Wangi pandan dan kemangi sangat mendominasi."
        ],
        tips: [
    ...
    },
    {
        ...
        image: "sulawesi_utara_cakalang_fufu.jpeg",
        prepTime: "15 Menit",
        cookTime: "15 Menit",
        servings: 4,
        difficulty: "Mudah",
        ingredients: [
            "1 ekor Ikan Cakalang Fufu (Ikan Asap) - Suwir kasar",
            "## Bumbu Rica (Tumbuk Kasar)",
            "20 Cabai Merah Keriting",
            "15 Cabai Rawit Merah (Wajib Pedas)",
            "10 Bawang Merah",
            "4 Bawang Putih",
            "3 cm Jahe (Geprek)",
        ...
        instructions: [
            "**Siapkan Ikan**: Suwir daging ikan cakalang asap, buang durinya. Goreng sebentar saja (opsional, agar lebih garing).",
            "**Tumis Rica**: Tumis bumbu tumbuk kasar, jahe, serai, dan irisan daun jeruk dengan minyak agak banyak. Masak sampai matang dan minyak berwarna merah.",
            "**Masak Ikan**: Masukkan suwiran ikan. Aduk rata dengan sambal rica.",
            "**Seasoning**: Beri garam, gula (sedikit saja), dan perasan jeruk nipis. Masak sampai bumbu meresap kering.",
            "**Sajikan**: Lauk nasi hangat yang bikin boros nasi."
        ],
        tips: [
    ...
    // --- GORONTALO (3 Recipes) ---
    {
        ...
        ingredients: [
            ...
            "1 Liter Air",
            "100 gr Udang Kupas (Kecil)",
            "1/2 butir Kelapa Parut (Kupas kulit arinya, agar putih)",
            "1 ekor Ikan Cakalang/Tongkol (Kukus/Bakar, suwir)",
            "## Bumbu Iris (Cemplung)",
            "10 Bawang Merah (Iris tipis)",
            "Cabai Rawit Merah (Iris)",
            "Daun Bawang & Kemangi",
            "Jeruk Nipis (Wajib Banyak)"
        ],
        instructions: [
            "**Rebus Jagung**: Rebus jagung pipil sampai matang manis.",
            "**Masukkan Bumbu**: Masukkan irisan bawang merah (mentah) dan cabai rawit ke dalam rebusan. (Gaya Gorontalo bumbunya diiris cemplung, bukan ditumis).",
            "**Sedap Malam**: Masukkan udang kupas dan suwiran ikan cakalang. Masak sampai udang matang.",
            "**Kelapa**: Masukkan kelapa parut segar. Aduk rata. Kelapa memberikan rasa gurih 'crunchy' dan kuah sedikit putih (milky).",
            "**Finishing**: Beri garam, kemangi, daun bawang. Matikan api.",
            "**Sajikan**: Hidangkan panas dengan kucuran air jeruk nipis yang banyak. Rasanya segar pecah di mulut."
        ],
        tips: [
    ...
    },
    {
        ...
        image: "gorontalo_ayam_iloni.jpeg",
        prepTime: "30 Menit",
        cookTime: "45 Menit",
        servings: 4,
        difficulty: "Sedang",
    ...
    },
    {
        ...
        image: "gorontalo_sate_tuna.jpeg",
        prepTime: "15 Menit",
        cookTime: "10 Menit",
        servings: 4,
        difficulty: "Mudah",
        ingredients: [
            "500 gr Daging Tuna Segar (Loin/Dada) - Potong dadu 3cm",
            "Air Jeruk Nipis",
            "Baram",
            "Bumbu Oles: Kecap Manis + Minyak + Bawang Putih Halus",
            "## Dabu-Dabu Lilang (Iris)",
            "10 Cabai Rawit Merah",
            "5 Bawang Merah",
            "1 Tomat Merah (Potong dadu)",
            "1 Jeruk Nipis, Minyak Panas"
        ],
        instructions: [
            "**Marinasi**: Lumuri dadu tuna dengan jeruk nipis dan garam. Diamkan 10 menit. Tekstur tuna akan memutih.",
            "**Tusuk**: Tusuk daging tuna padat.",
            "**Bakar**: Bakar di api besar sebentar saja (Seared). Jangan overcook agar dalamya masih juicy (medium). Olesi bumbu kecap bawang.",
            "**Dabu-Dabu**: Campur irisan cabai, bawang, tomat. Siram minyak panas. Beri jeruk nipis dan garam.",
    ...
    // --- SULAWESI TENGAH (3 Recipes) ---
    {
        ...
        servings: 4,
        difficulty: "Mudah (Waktu Lama)",
        ingredients: [
            "1 kg Tulang Kaki Sapi (Ada sumsumnya) + Daging Tetelan",
            "2 Liter Air",
            "2 batang Serai (Geprek)",
            "10 buah Cabai Rawit Hijau (Tumbuk kasar/utuh)",
            "## Bumbu Utama",
            "Asam Jawa Mentah/Muda (Rebus, saring airnya) - Harus Asam Kuat",
            "Garam, Penyedap (Wajib gurih)",
            "Singkong (Rebus empuk) sebagai pengganti nasi"
        ],
        instructions: [
            "**Rebus Tulang**: Rebus tulang kaki sapi sampai empuk (daging lepas dari tulang). Buang buih kotornya. Air kaldu harus bening.",
            "**Bumbui**: Masukkan air asam jawa, serai, dan cabai rawit hijau tumbuk kasar. (Kaledo bumbunya SANGAT MINIMALIS, tanpa bawang merah/putih/kunyit).",
            "**Seasoning**: Beri garam dan penyedap yang cukup berani. Rasa Kaledo harus: Asam Nendang, Pedas Rawit, Gurih Kaldu Sapi.",
    ...
    },
    {
        ...
        image: "sulawesi_tengah_uta_dada.jpeg",
        prepTime: "30 Menit",
        cookTime: "40 Menit",
        servings: 4,
        difficulty: "Sedang",
        ingredients: [
            "1 ekor Ayam Kampung / Ikan Tuna (Potong, Bakar setengah matang)",
        ...
        instructions: [
            "**Bakar Protein**: Panggang/bakar ayam atau ikan di atas bara sampai harum asap (setengah matang). Sisihkan.",
            "**Tumis Bumbu**: Tumis bumbu halus dan tomat iris sampai hancur matang.",
            "**Masak Kuah**: Tuang santan. Masak sampai mendidih.",
            "**Masukkan Ayam**: Masukkan ayam/ikan bakar. Masak api kecil sampai santan menyusut dan berminyak.",
    ...
    },
    {
        ...
        image: "sulawesi_tengah_duo_saleh.jpeg",
        prepTime: "10 Menit",
        cookTime: "15 Menit",
        servings: 1,
        difficulty: "Mudah",
        ingredients: [
            "100 gr Ikan Teri Palu (Teri Nasi Halus) - Goreng kering",
            "20 Cabai Rawit Merah (Ulek kasar)",
            "5 Bawang Merah (Iris tipis)",
            "3 buah Tomat Merah (Potong dadu kecil)",
            "Minyak Goreng",
            "Gula Garam"
        ],
        instructions: [
            "**Goreng Teri**: Goreng teri nasi sampai kering renyah. Angkat.",
            "**Tumis Bumbu**: Tumis bawang merah dan cabai ulek sampai harum.",
            "**Masak Tomat**: Masukkan potongan tomat. Masak sampai tomat hancur menjadi saus kental berminyak.",
            "**Campur**: Masukkan teri goreng. Aduk rata. Masak sebentar agar rasa menyatu.",
    ...
    // --- SULAWESI BARAT (3 Recipes) ---
    {
        ...
        difficulty: "Sedang",
        ingredients: [
            "1 kg Ikan Laut (Tuna/Cakalang/Layang)",
            "Minyak Kelapa Murni (Virgin Coconut Oil/Minyak Mandar) - Wajib",
            "## Bumbu Halus",
            "10 Bawang Merah (Dominan bawang merah)",
            "10 Cabai Rawit",
            "3 cm Kunyit",
            "## Asam",
            "Mangga Muda (Cacah/Iris panjang) atau Belimbing Wuluh kering",
            "3 batang Serai (Geprek), Daun Bawang"
        ],
        instructions: [
            "**Campur Mentah**: Di wajan, campur bumbu halus, ikan, irisan mangga muda, serai, daun bawang, dan MINYAK KELAPA. Remas-remas ikan dengan bumbu agar meresap.",
            "**Tuang Air**: Tuang air secukupnya (jangan terlalu banyak).",
            "**Masak**: Nyalakan api. Masak ikan sampai matang dan kuah mengental berminyak (emulsi minyak kelapa dan kaldu ikan).",
            "**Rasa**: Gurih Minyak Kelapa, Asam Mangga, Pedas, Wangi Bawang.",
    ...
    },
    {
        ...
        image: "sulawesi_barat_jepa.jpeg",
        prepTime: "20 Menit",
        cookTime: "10 Menit",
        servings: 4,
        difficulty: "Sedang (Alat)",
        ingredients: [
            "500 gr Singkong Parut (Peras airnya sampai kering jadi ampas)",
            "1/2 butir Kelapa Parut (Setengah tua)",
            "Garam",
            "Gula Merah sisir (untuk isian, jika versi manis)"
        ],
        instructions: [
            "**Siapkan Bahan**: Campur ampas singkong peras dengan kelapa parut dan sedikit garam. Aduk rata sampa berbutir-butir.",
            "**Panggang**: Panaskan wajan tanah liat datar. Taburkan adonan singkong membentuk lingkaran tipis. Ratakan.",
            "**Matangkan**: Biarkan bagian bawah matang menyatu. Balik (jika perlu) atau tutup agar matang uap.",
            "**Isi (Opsional)**: Bisa diberi irisan gula merah di tengahnya (Jepa Manis).",
    ...
    },
    {
        ...
        image: "sulawesi_barat_golla_kambu.jpeg",
        prepTime: "1 Jam",
        cookTime: "1 Jam",
        servings: 10,
        difficulty: "Sedang",
        ingredients: [
            "500 gr Beras Ketan (Kukus matang)",
            "1 butir Kelapa Parut (Kupas kulit, parut memanjang)",
            "300 gr Gula Merah (Sisir)",
            "100 gr Kacang Tanah Sangrai (Cincang kasar) - Khasnya",
            "Daun Pisang Kering (Klaras) untuk bungkus"
        ],
        instructions: [
            "**Masak Gula**: Masak gula merah dengan sedikit air sampai larut dan kental berserabut (rambut nenek).",
            "**Campur Kelapa**: Masukkan kelapa parut ke dalam gula. Masak sampai menyatu (unti).",
            "**Masukkan Ketan**: Masukkan ketan kukus dan kacang tanah sangrai. Aduk rata di atas api kecil sampai kalis dan berminyak.",
            "**Bungkus**: Ambil sesendok adonan. Bungkus padat dengan daun pisang kering bentuk wajik/kotak.",
    ...
    // --- SULAWESI SELATAN (3 Recipes) ---
    {
        ...
        cookTime: "2 Jam",
        servings: 6,
        difficulty: "Sulit (Kompleks)",
        ingredients: [
            "1 kg Daging Sapi & Jeroan (Hati, Jantung, Babat)",
            "2 Liter Air Tajin (Air cucian beras ke-2 dan 3)",
            "250 gr Kacang Tanah (Sangrai, buang kulit, blender SANGAT HALUS sampai berminyak)",
            "## Bumbu Halus (Tumis)",
            "15 Bawang Merah, 8 Bawang Putih",
            "10 butir Kemiri Sangrai",
            "1 sdm Ketumbar, 1 sdj Jinten Sangrai",
            "1 batang Serai, Lengkuas, Jahe",
            "3 sdm Tauco (Haluskan)",
            "## Rempah Lain",
            "Kayu Manis, Cengkeh, Pala"
        ],
        instructions: [
            "**Rebus Daging**: Rebus daging dan jeroan dengan Air Tajin dan rempah utuh (salam, serai, lengkuas) sampai empuk. Potong dadu.",
            "**Tumis Bumbu**: Tumis bumbu halus dan tauco sampai sangat wangi dan matang berubah warna.",
            "**Campur**: Masukkan bumbu tumis ke panci kaldu.",
            "**Pengental**: Masukkan KACANG TANAH halus. Aduk rata. Kuah akan menjadi kental, keruh, dan gurih creamy.",
            "**Seasoning**: Garam, gula, penyedap rasa.",
            "**Penyajian**: Tata daging di mangkuk kecil. Siram kuah kental. Beri bawang goreng, daun bawang, dan perasan Jeruk Nipis.",
            "**Pendamping**: Ketupat (Burasa) dan Sambal Tauco Pedas."
        ],
        tips: [
    ...
    },
    {
        ...
        image: "sulawesi_selatan_pallubasa.jpeg",
        prepTime: "40 Menit",
        cookTime: "1.5 Jam",
        servings: 4,
        difficulty: "Sedang",
        ingredients: [
            ...
            "100 gr Kelapa Parut (Sangrai coklat tua, tumbuk halus berminyak) - Wajib",
            "1 Liter Kaldu Sapi",
            "50 ml Santan Kental",
            "Telur Ayam Kampung (untuk Alas)",
            "## Bumbu Halus",
            "10 Bawang Merah, 4 Bawang Putih",
            "5 Cabai Merah Keriting",
            "1 sdt Ketumbar, Jinten, Pala",
            "Serai, Lengkuas, Kayu Manis, Cengkeh"
        ],
        instructions: [
            "**Rebus Daging**: Rebus daging sampai empuk. Potong kotak. Simpan kaldunya.",
            "**Tumis Bumbu**: Tumis bumbu halus dan rempah aromatik sampai matang.",
            "**Masak Kuah**: Masukkan bumbu ke kaldu. Masukkan santan kental.",
            "**Kelapa Sangrai**: Masukkan kelapa sangrai tumbuk. Aduk rata. Kuah akan menjadi gelap dan berpasir gurih.",
            "**Seasoning**: Garam, gula, air asam jawa sedikit.",
            "**Alas**: Pecahkan kuning telur ayam kampung mentah di mangkuk saji. Siram dengan kuah panas mendidih dan daging. Kuning telur akan matang 'creamy' kena kuah panas.",
    ...
    },
    {
        ...
        image: "sulawesi_selatan_konro_bakar_iga.jpeg",
        prepTime: "30 Menit",
        cookTime: "2 Jam",
        servings: 2,
        difficulty: "Sedang",
        ingredients: [
            "1 kg Iga Sapi (Ribs) berdaging tebal",
            "2 Liter Air",
            "Kluwak (Opsional, untuk kuah hitam) / Atau Kunyit (kuah merah)",
            "## Bumbu Rebus Iga",
            "Bawang Merah, Putih, Pala, Cengkeh, Kayu Manis, Ketumbar, Jinten, Lengkuas (Haluskan)",
            "## Bumbu Oles Bakar (Saus Kacang)",
            "100 gr Kacang Goreng Halus",
            "Bawang Putih, Cabai Merah (Tumis)",
            "Kecap Manis, Air Asam, Kaldu Konro"
        ],
        instructions: [
            "**Rebus Iga**: Rebus iga dengan bumbu halus rempah (pala, cengkeh wajib kuat) sampai SANGAT EMPUK (daging mau lepas).",
            "**Siapkan Bakaran**: Angkat iga. Tiriskan.",
            "**Buat Saus**: Campur kacang halus, bumbu tumis, kecap manis, dan sedikit kuah konro kental. Aduk jadi pasta.",
            "**Bakar**: Olesi iga dengan bumbu kacang. Bakar di arang sampai wangi dan bumbu caramelize.",
            "**Sajikan**: Letakkan Konro Bakar di piring. Sajikan mangkuk terpisah berisi Kuah Sup Konro (sisa rebusan) tabur bawang goreng.",
    ...
    // --- SULAWESI TENGGARA (3 Recipes) ---
    {
        ...
        image: "sulawesi_tenggara_sinonggi.jpeg",
        prepTime: "15 Menit",
        cookTime: "15 Menit",
        servings: 4,
        difficulty: "Sedang (Teknik Siram)",
        ingredients: [
            "300 gr Tepung Sagu (Rendam air, endapkan, buang air beningnya) - Ambil pati basah",
            "Air Mendidih",
            "Jeruk Nipis",
            "## Sayur Pendamping",
            "Sayur Bening Bayam/Kangkung/Kacang Panjang",
            "## Lauk Pendamping",
            "Ikan Palumara (Kuah Kuning Asam)"
        ],
        instructions: [
            "**Siapkan Sagu**: Taruh pati sagu basah di wadah tahan panas. Beri perasan jeruk nipis (agar putih bersih). Cairkan dengan sedikit air dingin.",
            "**Siram**: Didihkan air sampai benar-benar MENDIDIH GEOLAK. Tuang air panas SEDIKIT DEMI SEDIKIT ke sagu sambil DIADUK CEPAT & KUAT. Sagu akan berubah warna dari putih susu menjadi BENING LEM (Matang).",
            "**Mosonggi**: Tradisi makan Sinonggi (Mosonggi) adalah mengambil sagu lengket dengan dua bilah bambu/sumpit, diputar-putar (digulung) lalu ditaruh di piring.",
    ...
    },
    {
        ...
        image: "sulawesi_tenggara_ikan_parende.jpeg",
        prepTime: "20 Menit",
        cookTime: "25 Menit",
        servings: 4,
        difficulty: "Mudah",
        ingredients: [
            "1 ekor Ikan Kakap Merah / Kerapu (Potong)",
            "1 Liter Air",
            "Tomat & Belimbing Wuluh",
            "Kemangi",
            "## Bumbu Iris (Cemplung)",
            "8 Bawang Merah",
            "4 Bawang Putih",
            "2 batang Serai, 1 ruas Jahe, 2 cm Kunyit (Geprek/Iris)",
            "10 Cabai Rawit utuh",
            "Air Asam Jawa"
        ],
        instructions: [
            "**Rebus Air**: Masak air dengan semua bumbu iris/geprek sampai mendidih dan wangi.",
            "**Masak Ikan**: Masukkan ikan. Masak sampai matang (mata ikan memutih).",
            "**Asam Segar**: Masukkan air asam jawa, tomat potong, dan belimbing wuluh. Bumbui garam gula.",
            "**Finishing**: Masukkan kemangi dan cabai rawit utuh. Angkat.",
            "**Rasa**: Asam, Segar, Ringan.",
    ...
    },
    {
        ...
        image: "sulawesi_tenggara_kabuto.jpeg",
        prepTime: "1 Malam (Rendam)",
        cookTime: "30 Menit",
        servings: 4,
        difficulty: "Mudah",
        ingredients: [
            "500 gr Singkong Kering (Gaplek/Kakupu) - Yang hitam/berjamur aman diproses",
            "1/2 butir Kelapa Parut (Kukus dengan garam)",
            "Ikan Asin Goreng",
            "Minyak Kelapa (Opsional)"
        ],
        instructions: [
            "**Rendam**: Rendam singkong kering semalaman (min 8 jam) sampai lunak mengembang. Cuci bersih berkali-kali. Tiriskan.",
            "**Kukus**: Potong-potong singkong. Kukus selama 30-45 menit sampai matang kenyal.",
            "**Campur**: Campur singkong kukus panas dengan kelapa parut asin. Beri sedikit minyak kelapa agar wangi.",
            "**Sajikan**: Makan Kabuto sebagai pengganti nasi dengan lauk Ikan Asin dan Sambal Terasi.",
